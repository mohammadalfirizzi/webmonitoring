...
?>
             <canvas id=myChartdua width="300" height="100" style="margin-left: -4%"></canvas>
              <div class="content">
        <div class="row">
          <div class="col-md-12">
              </div>
              ...
              <div class="card-footer ">
                <hr>
                <div class="stats">
                  <i class="fa fa-history"></i> Updated 7 minutes ago
                </div>
              </div>
            </div>
          </div>
...
<script>
	var canvas = document.getElementById('myChartdua');
        var data = {
            ...
            datasets: [
            {
                ...
                pointRadius: 5,
                pointHitRadius: 10,
                data: [<?php while ($b = mysqli_fetch_array($temp)) { echo  $b['temp'] . ',';}?>],
            },
            {
                label: "Humidity", 
