          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Data Table of Air Condition</h4>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                      <?php
                      $dev = "DEVICE 1";
            $sql = "SELECT * FROM data ORDER BY reading_time DESC LIMIT 0,20";
            $result = $conn->query($sql);
            if ($result->num_rows > 0) {
            // output data of each row
                while($row = $result->fetch_assoc()) {
                echo "<tr><td>" . $row["mac"]. "</td><td>". $row["reading_time"]. "</td><td>"
                . $row["temp"]. "</td><td>". $row["humid"]. "</td><td>". $row["pm2_5"]. "</td><td>". $row["pm10_0"]. "</td><td>". $row["alt"]. "</td><td>". $row["pres"]. "</td></tr>";
                }
            }
          ?>
                    </tbody>
